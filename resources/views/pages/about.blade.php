...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">About</li>
        ...
        <section>
                <div class="about-company-section" style="padding-top: 51px">
                        <div class="container h5-1 h5-sm-3">
                                <div class="row">
                                        <div class="col-12 text-center">
                                                <h2>About Laravel Application</h2>
                                                <hr>
                                        </div>
                                        <div class="col-md-5 pt-3" style="padding-top: 25px">
                                        ...
                                        <div class="col-md-7 text-justify pt-2">
        ...
        <section class="pt-4 pb-5">
                <div class="container">
                    ...
                    <div class="row pt-4">
                        <div class="col-12 text-center">
                            <img src="/sheena" alt="" width="30%">
                            <h4>Sheena P. Ponsica</h4>
                            <h5>Chief Executive officer <br> CEO </h5>
                        </div>
                    </div>
                    <div class="row pt-5">
                        <div class="col-md-4 text-center">
                            <img src="../team/donna.jpg" alt="" width="22%">
                            <h5>Donna S. Claros</h5>
                            <h5>Web Designer</h5>
        
                        </div>
                        <div class="col-md-4 text-center">
                            <img src="./team/carl.jpg" alt="" width="25%">
                            <h5>Carl C. Bastida</h5>
                            <h5>Web Developer</h5>
                        </div>
                        <div class="col-md-4 text-center">
                            <img src="./team/hazel.jpg" alt="" width="28%">
                            <h5>Hazel Eunice N. Arsenal</h5>
                    ...
                    <div class="row pt-5">
                        <div class="col-md-4 text-center">
                            <img src="./team/jam.jpg" alt="" width="30%">
                            <h5>Jesza Aira Marie S. Olorvida</h5>
                            <h5>Business Analyst</h5>
        
                        </div>
                        <div class="col-md-4 text-center">
                            <img src="./team/jd.jpg" alt="" width="25%">
                            <h5>Jose Delfin S. Austria</h5>
                            <h5>Content Editor</h5>
                        </div>
                        <div class="col-md-4 text-center">
                            <img src="./team/mia.jpg" alt="" width="30%">
                            <h5>Mia S. Gallegos</h5>
                            <h5>Sales Head</h5>
                        </div>
                    </div>
                </div>
